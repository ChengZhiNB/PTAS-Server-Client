...
public class AboutPage extends StackPane {
    ...
    public AboutPage() {
        ComponentList about = new ComponentList();
        {
            ...
            launcher.setTitle("PTAS服务器客户端");
            launcher.setSubtitle(Metadata.VERSION);
            launcher.setExternalLink("https://hmcl.huangyuhui.net");

            IconedTwoLineListItem author1 = new IconedTwoLineListItem();
            author1.setImage(new Image("/assets/img/ChengZhi.png", 32, 32, false, true));
            author1.setTitle("橙汁");
            author1.setSubtitle(i18n("本启动修改者,QQ号: 292200693"));
            author1.setExternalLink("https://space.bilibili.com/687901384");
            ...
            author.setSubtitle(i18n("HMCL启动器作者"));
            author.setExternalLink("https://space.bilibili.com/1445341");

            about.getContent().setAll(launcher, author1, author);
        }
