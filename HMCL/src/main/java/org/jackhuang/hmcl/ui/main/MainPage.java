...
public final class MainPage extends StackPane implements DecoratorPage {
    ...
    public MainPage() {
        announcementPane.getChildren().add(new AnnouncementCard("温馨提示", "如果你之前有在本服务器拥有账户，请使用相同的ID注册豹豹皮肤站。\n\n本启动器由橙汁(QQ292200693)修改,本启动基于HMCL开源项目修改。\nHMCL版本:3.5.3.227,原作者:huangyuhui"));
    }
